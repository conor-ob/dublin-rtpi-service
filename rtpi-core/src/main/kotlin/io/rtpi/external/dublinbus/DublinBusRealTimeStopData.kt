...
data class DublinBusRealTimeStopDataXml(
    ...
    @field:Element(name = "MonitoredVehicleJourney_OperatorRef") var operator: String? = null,
    @field:Element(name = "MonitoredVehicleJourney_DestinationName") var destination: String? = null,
    @field:Element(name = "MonitoredVehicleJourney_DirectionRef") var direction: String? = null,
    @field:Element(name = "MonitoredCall_ExpectedArrivalTime") var expectedTimestamp: String? = null,
    @field:Element(name = "MonitoredCall_AimedArrivalTime") var scheduledTimestamp: String? = null,
